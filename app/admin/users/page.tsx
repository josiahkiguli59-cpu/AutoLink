    ...
    <div className="space-y-6">
      <div className="pb-6 border-b border-border/60">
        ...
        <p className="text-xs text-slate-400 mt-1">
          Manage buyer, seller, and administrator accounts, assign access privileges, and verify registered dealerships.
        </p>
      </div>
                ...
                <tr key={u.id} className="hover:bg-surface-200/40 transition-colors">
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="relative h-10 w-10 rounded-full overflow-hidden bg-surface-200 shrink-0 border border-border">
                        <Image
                          src={u.avatar_url || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&q=80'}
                          alt={u.full_name}
                          fill
                  ...
                  <td className="p-4">
                    <div className="space-y-0.5 text-[11px] text-slate-300">
                      ...
                      <div className="text-whatsapp">WA: {u.whatsapp || 'N/A'}</div>
                    </div>
                  </td>
                  <td className="p-4">
                    <span
